...
urlpatterns = [
    ...
    path('comments/<int:pk>/', CommunityPostCommentDetails.as_view(), name='community_post_comment_details'),
    ...
    path('communities/<int:pk>/members/', ListMember.as_view(), name='add_member'),
